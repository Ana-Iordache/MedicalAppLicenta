    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Investigatie i=new Investigatie(et2.getText().toString(),Double.parseDouble(et3.getText().toString()));
                investigatii.add(i);
            }
        });
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Specialitate specialitate = new Specialitate(null, et1.getText().toString(),investigatii);
